...
** Overview
 ...
 solution. It's a great learning opportunity, and it stays up all year,
 and into the future. Huge shout-out to SANS for putting on this event.
 ...
 of appendices that go into more detail on certain topics. We hope you
 enjoy it.
* tl;dr: Quick Answers
...
5. How many infractions are required to be marked as naughty? *4*\\
   What are the names of at least six insider threat moles? *Isabel Mehta, Nina Fitzgerald, Kirsty Evans, Sheri Lewis, Beverly Khalil, Christy Srivastava*\\
